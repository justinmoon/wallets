...
def load_watchonly(bitcoind_wallet_names):
    default_rpc = WalletRPC('')
    bitcoind_wallets = default_rpc.listwallets()
    bitcoind_wallet_names = ['buidl-' + name for name in bitcoind_wallet_names]
    for bitcoind_wallet_name in bitcoind_wallet_names:
